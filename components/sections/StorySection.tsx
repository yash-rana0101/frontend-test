      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center gap-20">
          ...
          <div className="flex flex-col items-center gap-2 max-w-159 text-center">
            <p className="text-[14px] text-black/64 font-normal uppercase tracking-[-0.5px] font-['Montserrat',sans-serif]">
              Glimpse of happiness
            </p>
            <h2 className="text-[30px] font-semibold text-black leading-normal tracking-[-1px] font-['Montserrat',sans-serif]">
          ...
          <div className="flex flex-col gap-10 w-full items-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              <button className="h-12 px-4 py-2 rounded-lg border-2 border-[#E10174] text-black text-base font-medium hover:bg-[#E10174] hover:text-white transition-colors font-['Montserrat',sans-serif] tracking-[-0.5px]">
                Share your story with us
              </button>
              <button className="text-black text-base font-normal underline decoration-solid hover:no-underline transition-all font-['Montserrat',sans-serif] tracking-[-0.5px]">
