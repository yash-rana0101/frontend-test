      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center gap-10 md:gap-20">
          ...
          <div className="flex flex-col items-center gap-2 max-w-159 text-center">
            ...
            <h2 className="text-[18px] md:text-[25px] font-semibold text-black leading-normal tracking-[-1px] font-['Montserrat',sans-serif]">
          ...
          <div className="flex flex-col gap-10 w-full items-center">
            ...
            <div className="flex flex-row md:flex-row items-center justify-center gap-2 md:gap-4 w-full md:w-auto">
