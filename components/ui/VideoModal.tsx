  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative bg-[#FDF2F9] rounded-[40px] p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto flex gap-6"
          ...
          >
            ...
            <div className="flex flex-col gap-4 items-center justify-center shrink-0">
              <div className="relative w-[320px] h-131.25 rounded-2xl overflow-hidden">
                <Image
                  src={thumbnailUrl}
                  alt="Video thumbnail"
                  fill
